    ...
    <div class="form-section">
        ...
        <form action="ChangeStudentInfo" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="studentID" name="studentID" value="${basicInfo.studentID}" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label for="name" class="col-sm-2 col-form-label">姓名</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" value="${basicInfo.name}">
                </div>
            </div>
            <div class="form-group row">
                <label for="namePY" class="col-sm-2 col-form-label">姓名拼音</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="namePY" name="namePY" value="${basicInfo.namePY}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="Date" class="form-control" id="birthDate" name="birthDate" value="${basicInfo.birthDate}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="IDType" name="IDType" value="${basicInfo.IDType}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="maritalStatus" name="maritalStatus">
                        <option value="未婚" ${basicInfo.maritalStatus == '未婚' ? 'selected' : ''}>未婚</option>
                        <option value="已婚" ${basicInfo.maritalStatus == '已婚' ? 'selected' : ''}>已婚</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="birthPlace" name="birthPlace" value="${basicInfo.birthPlace}">
                </div>
            </div>
            <div class="form-group row">
                <label for="familyAddress" class="col-sm-2 col-form-label">家庭地址</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="familyAddress" name="familyAddress" value="${basicInfo.familyAddress}">
                </div>
            </div>
            <div class="form-group row">
                <label for="phoneNumber" class="col-sm-2 col-form-label">手机号码</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="phoneNumber" name="phoneNumber" value="${basicInfo.phoneNumber}">
                </div>
            </div>
            <div class="form-group row">
                <label for="campusEmail" class="col-sm-2 col-form-label">校内电子邮箱</label>
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="campusEmail" name="campusEmail" value="${basicInfo.campusEmail}">
                </div>
            </div>
            <div class="form-group row">
                <label for="personalEmail" class="col-sm-2 col-form-label">宿舍号</label>
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="personalEmail" name="personalEmail" value="${basicInfo.personalEmail}">
                </div>
            </div>
            <div class="form-group row">
                <label for="joinPartyDate" class="col-sm-2 col-form-label">入党日期</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="joinPartyDate" name="joinPartyDate" value="${basicInfo.joinPartyDate}">
                </div>
            </div>
